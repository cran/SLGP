...
#include "stanExports_likelihoodComposed.h"

RCPP_MODULE(stan_fit4likelihoodComposed_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_likelihoodComposed")
